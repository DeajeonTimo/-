...
import kr.or.ddit.board.service.JdbcServiceBoardImpl;
...
public class JdbcBoardController {
	...
	public JdbcBoardController() {
		...
		service= JdbcServiceBoardImpl.getInstance();
	}
	...
	//게시판 목록을 보여주고 메뉴를 나타내며 사용자가 입력한 작업번호를 입력 받아 반환하는 메서드
	private int displayMenu(String title) {
		...
		if(title==null || title.isEmpty()) {
			boardList = service.getAllBoardList();
			 ...
			 boardList = service.getSerchBoardList(title);
		}
