...
/*
 	...
 	3) 90 					==> 포트번호(80번은 생략 가능)
 	4) /webTest 			==> 컨텍스트 패스(보통 프로젝트 이름으로 지정된다.
 	5) /servletTest01.do    ==> 서블릿 요청 URL 패턴
 */




//  Servelt 클래스는 HttpServlet 클래스를 상속해서 작성한다.
public class ServletTest01 extends HttpServlet{

	// 이 영역에서는 service()메서드 또는 
	//	doGet()메서드나 doPost()메서드를 재정의해서 작성한다.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.append("<title>첫번째Servlet 연습</title>");
		out.append("</head>");
		out.append("<body>");
		out.append("<h1 style='text-align:center'>");		
		out.append(name+"씨 안녕하세요. 첫번째 Servelt 프로그램입니다.</h1>");		
		out.append("</body>");
		out.append("</html>");
		
		
	}
	//doPost()매서드 ==> POST방식의 요청을 처리하는 매서드
	@Override
