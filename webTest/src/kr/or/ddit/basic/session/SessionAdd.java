...
public class SessionAdd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//1. 새로운 Session 객체를 생성하느거나 현재의 세선 가져오기
		...
		//2. setAttribute()매서드로 Session에 값을 저장한다.
		//형식) Session객체.setAttribute("key값",session값);
		//		==> "key값"은 문자열, session값은 모든 종류의 데이터를 사용할 수 있다.
		...
		out.println("<html>");
		out.println("<head><meta charset='utf-8'><title>Session 저장연습</title></head>");
		out.println("<body>");
		out.println("<h3>Session이 저장되었습니다...</h3><br><br>");
