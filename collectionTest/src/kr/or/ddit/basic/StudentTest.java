...
public class StudentTest {
	...
	// 등수를 구하는 메서드
	public void createRanking(ArrayList<Student> stdList) {
	...
	public static void main(String[] args) {
		...
		stdList.add(new Student(3, "성춘향", 90, 15, 70));
		stdList.add(new Student(7, "강감찬", 95, 95, 80));
		stdList.add(new Student(5, "변학도", 80, 95, 90));
		stdList.add(new Student(4, "일지매", 100, 85, 80));
		stdList.add(new Student(2, "이순신", 60, 65, 70));
