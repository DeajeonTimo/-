...
/*
 	Vector, Hashtable등의 예전부터 존재하던 collection 객체들은 내부에 동기화 처리가 되어있다.
 	
 	그런데 새롭게 구성된 Collection들은 동기화 처리가 되어있지 않다.
 	
 	그래서 동기화가 필요한 프로그램에서는 이런 Collection들을 사용하려면 동기화 처리를 한 후에 사용해야한다.
 */
