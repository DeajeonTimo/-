...
class DataBox{
	...
	// data변수의 값이 null이면 data변수에 문자열이 채워질 때까지 기다리고,ㅣ
	...
	// data 변수에 값이 있으면 data변수가  null이 될때까지 기다린다.
	// data 변수가 null이 되면 새로운 data값을 저장한다.
	public synchronized void setData(String data) {
		...
		System.out.println("Thread에 새로 저장한 데이터 : " + data);
		notify();
